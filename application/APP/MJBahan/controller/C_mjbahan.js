Ext.define('Almindo.MJBahan.controller.C_mjbahan',{
			...
			init.function(){
				this.control({
					'GRID_mjbahan > toolbar > textfile[itemId=searchData]': {
			...
			searchData:function (f,e) {
				var store = Ext.getStore('Almindo.MJBahan.store.ST_mjbahan');//Ext.getStore('Almindo.Mcategory.store.ST_mcategory');//
				if (e.getKey() == e.ENTER) {
